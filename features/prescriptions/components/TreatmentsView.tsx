...
export const TreatmentsView: React.FC = () => {
  ...
  return (
    <div className="animate-fadeIn max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      ...
      <div className="mb-8 p-6 bg-brand-blue/5 border border-brand-blue/10 rounded-[2rem] flex items-start gap-4">
        <div className="size-10 rounded-xl bg-brand-blue/10 flex items-center justify-center text-brand-blue shrink-0">
          <span className="material-symbols-outlined">info</span>
        </div>
        <p className="text-xs font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
          <span className="font-black text-brand-blue uppercase tracking-tight">AI Safety Notice:</span> These pharmaceutical insights and reference data are generated by AI for informational purposes only. They must be verified against current medical literature and the patient's specific clinical context by a licensed professional.
        </p>
      </div>
          ...
          <div className="p-10 rounded-[3rem] bg-white dark:bg-zinc-900 text-slate-900 dark:text-white shadow-2xl border border-slate-100 dark:border-white/5 relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <button 
                ...
                className="w-full rounded-[1.5rem] bg-brand-blue dark:bg-white py-5 text-sm font-black text-white dark:text-slate-900 shadow-xl shadow-brand-blue/20 hover:shadow-brand-blue/40 transform hover:-translate-y-1 transition-all active:scale-95 flex items-center justify-center gap-3 uppercase tracking-widest border border-transparent dark:border-white/10 animate-glimmer"
              >
