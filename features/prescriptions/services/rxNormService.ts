import { RxNormCandidate } from '@/features/prescriptions';
    ...
    try {
      ...
      if (i === retries - 1) {
        ...
        if (e.message?.includes('Failed to fetch')) {
          throw new Error('Network error: Could not connect to RxNorm API. Please check your internet connection.', { cause: e });
        }
        throw e;
      }
